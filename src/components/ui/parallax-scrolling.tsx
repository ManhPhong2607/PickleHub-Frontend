        ...
        <div className="parallax__visuals">
          ...
          <div data-parallax-layers className="parallax__layers">
            ...
            <div data-parallax-layer="3" className="parallax__layer-title">
              <h2 className="parallax__title">PICKLEHUB</h2>
              <p className="text-emerald-400 font-bold uppercase tracking-widest text-sm sm:text-base mt-2">
                PRO PICKLEBALL EQUIPMENT & TECHNOLOGY
              </p>
            </div>
            <img
